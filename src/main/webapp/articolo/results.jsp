		                ...
		                <tbody>
		                    ...
		                    <tr >
		                        ...
		                        <td>
									...
									<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="PrepareModificaArticoloServlet?idArticolo=<%=item.getId() %>">Edit</a>
									<a class="btn btn-outline-danger btn-sm" href="PrepareRimuoviArticoloServlet?idArticolo=<%=item.getId() %>">Delete</a>
								</td>
		                    </tr>
		                    <% } %>
		                </tbody>
